...
interface AdvancedFilterBarProps {
  ...
  onApplySuggestion?: (suggestedKeyword: string) => void;
}
...
export function AdvancedFilterBar({
  ...
  const fetchPresets = async () => {
    ...
    try {
      const res = await fetch(`${getApiUrl()}/api/v1/search/presets?entityType=AGREEMENT`, {
  ...
  const hasActiveFilters =
    ...
    Boolean(filters.tag) ||
    Boolean(filters.authorEmail) ||
    Boolean(filters.recipientEmail);
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-col md:flex-row gap-2.5 items-stretch md:items-center justify-between bg-white p-2.5 rounded-2xl border border-neutral-200/80 shadow-xs">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Search documents by title, description, content, or file name..."
        ...
        <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
          ...
          >
            ...
            {filters.keyword && <option value="relevance:desc">Relevance</option>}
          </select>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => onFilterChange({ ...filters, documentType: e.target.value })}
                className="w-full px-3 py-1.5 bg-white border border-neutral-200 rounded-xl text-xs text-neutral-800 focus:outline-none focus:ring-2 focus:ring-[#ba0000]/20"
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => onFilterChange({ ...filters, recipientEmail: e.target.value })}
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 px-1 py-0.5 text-xs">
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            {filters.documentType && filters.documentType !== 'all' && (
              <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-neutral-100 text-neutral-800 rounded-lg text-xs font-medium">
                Type: {filters.documentType.toUpperCase()}
                <button
                  onClick={() => onFilterChange({ ...filters, documentType: 'all' })}
                  className="hover:text-red-600"
                >
                  &times;
                </button>
            ...
            {filters.recipientEmail && (
              <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-neutral-100 text-neutral-800 rounded-lg text-xs font-medium">
                Recipient: {filters.recipientEmail}
                <button
                  onClick={() => onFilterChange({ ...filters, recipientEmail: '' })}
                  className="hover:text-red-600"
                >
                  &times;
                </button>
          ...
          <div className="flex items-center gap-3 text-neutral-400 text-[11px] ml-auto">
            {totalResults !== undefined && (
              <span>
                Found <strong className="text-neutral-700">{totalResults}</strong> documents
              </span>
            )}
      ...
      {/* Fuzzy "Did you mean?" suggestion banner (INK-122) */}
          ...
          <div className="flex items-center gap-2">
            ...
            <span>
              ...
              <button
                ...
                className="font-bold text-[#ba0000] underline hover:text-[#900000]"
              >
                &quot;{suggestion}&quot;
              </button>
              ?
