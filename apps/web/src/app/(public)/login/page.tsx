...
function LoginContent() {
  ...
  if (showMfaPrompt) {
    return (
      <div className="space-y-6" data-testid="mfa-login-step">
        <div>
        ...
        >
          ...
          <div>
            <label htmlFor="totpCode" className="block text-sm font-medium text-neutral-700 text-center">
              Verification Code
            </label>
            <input
              id="totpCode"
              ...
              className="mt-2 block w-full text-center tracking-[0.5em] font-mono text-2xl rounded-lg border border-neutral-300 px-3.5 py-3 shadow-sm focus:border-[#ba0000] focus:ring-2 focus:ring-[#ba0000]/20"
              placeholder="123456"
          ...
          <button
            ...
            data-testid="mfa-login-submit-button"
          >
